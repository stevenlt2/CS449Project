...
public class GUI extends JFrame {
	...
	public class MyActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (simple.isSelected() && !general.isSelected() && e.getSource()==newGameBTN && !blueCPUbtn.isSelected() && !redCPUbtn.isSelected()) { 			//Resizes Grid for Simple Mode (No CPU)
				...
				timer.schedule(task2, 2000, 5000);
			}
